...
data class AssignmentTemplate(var AssignmentID: Int, var UserID: Int, var Mode: Byte, var QuarterID: Int?, var RoadID: Int?, var IsFinished: Boolean, var CreateDate: String,
